...
<header>
    <div class="sticky-nav">
        ...
        <nav id="menu">
        	<ul id="menu-nav">
            	<li class="modiSpr"><a href="index-index#shortcodes" class="external"><span class="espace">Modifier données</span></a></li>
                <li class="decSpr"><a href="deconnexion" class="external"><span class="espace">Déconnexion</span></a></li>
            </ul>
        </nav>
...
<?php
    if($_GET['page'] == 'index'){
        ...
        include('modifCat.php');
    }
    else if($_GET['page'] == 'modifJeu'){
        include('modifJeu.php');
    }
?>
